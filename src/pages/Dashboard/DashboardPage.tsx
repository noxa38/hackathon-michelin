...
import ProfessionalRequestForm from '../../components/features/Professional/ProfessionalRequestForm'
...
import AddFavoriteModal from '../../components/features/Restaurant/AddFavoriteModal'
import AddAccommodationModal from '../../components/features/Accommodation/AddAccommodationModal'
import RestaurantDetailModal from '../../components/features/Restaurant/RestaurantDetailModal'
import AccommodationDetailModal from '../../components/features/Accommodation/AccommodationDetailModal'
...
export default function DashboardPage() {
  ...
  async function handleFriendAccommodationLikeToggle(accommodation: Accommodation) {
    ...
    const numericId = Number(String(accommodation.id).replace(/^[a]-/, ''))
    if (!Number.isFinite(numericId)) return
